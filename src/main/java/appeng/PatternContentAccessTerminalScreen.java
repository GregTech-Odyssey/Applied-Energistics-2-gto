...
public class PatternContentAccessTerminalScreen<C extends PatternContentAccessTerminalMenu> extends AEBaseScreen<C> {
    ...
    public PatternContentAccessTerminalScreen(C menu, Inventory playerInventory, Component title, ScreenStyle style) {
