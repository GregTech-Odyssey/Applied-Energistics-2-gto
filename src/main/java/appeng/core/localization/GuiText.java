...
public enum GuiText implements LocalizationEnum {
    ...
    TerminalManualPinnedRow("Manual Pins"),
    TerminalManualPinnedRowShown("Shown below auto-crafted pins"),
    TerminalManualPinnedRowHidden("Hidden; manually pinned items stay in the normal list"),
